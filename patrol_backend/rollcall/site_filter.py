"""Site scope for rollcall v5 list/export. Live rollcall views do not use this."""
...
def apply_rollcall_site_filter(queryset, request):
    caller = request.user
    ...
    # Header All: org sessions, including legacy rows with no site.
