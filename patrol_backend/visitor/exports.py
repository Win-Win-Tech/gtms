    ...
    for entry in queryset:
        ...
        ws.append(
            [
                ...
                _fmt_dt(entry.expected_arrival_time, user_tz),
                _fmt_dt(entry.expected_out_time, user_tz),
                entry.visit_date.strftime("%d-%b-%Y") if entry.visit_date else "",
