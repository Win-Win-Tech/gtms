...
def _draw_attendance_pdf_footer(canvas, doc):
    """Centered footer on every page with page numbers."""
...
def build_daily_attendance_detail_pdf_bytes(context, employee_groups):
    ...
    doc.build(
        story,
        onFirstPage=_draw_attendance_pdf_footer,
        onLaterPages=_draw_attendance_pdf_footer,
    )
